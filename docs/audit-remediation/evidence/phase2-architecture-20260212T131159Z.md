...
| EventsFastLaneDLQURL | 0 | 0 | 0 |
| InventoryReconcileQueueURL | 0 | 0 | 0 |
| InventoryReconcileDLQURL | 0 | 0 | 0 |
...
- `security-autopilot-events-dlq-age` (OK) [AWS/SQS:ApproximateAgeOfOldestMessage]
- `security-autopilot-events-dlq-depth` (OK) [AWS/SQS:ApproximateNumberOfMessagesVisible]
...
- `security-autopilot-inventory-dlq-age` (OK) [AWS/SQS:ApproximateAgeOfOldestMessage]
- `security-autopilot-inventory-dlq-depth` (OK) [AWS/SQS:ApproximateNumberOfMessagesVisible]
...
- JSON: `docs/audit-remediation/evidence/phase2-architecture-20260212T131159Z.json`
- Markdown: `docs/audit-remediation/evidence/phase2-architecture-20260212T131159Z.md`
