# AWS Config enablement - Action: fc92b8d7-fdd6-4ace-9b29-37c9b8a18d60
# Remediation for: Enable AWS Config (Live Test D2)
...
variable "delivery_bucket_name" {
  type        = string
  default     = "sa-live-d2-config-029037611564-0304013921"
