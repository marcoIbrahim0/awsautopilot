...
Generated at: `2026-02-12T11:58:09.868477+00:00`
Region: `eu-north-1`
...
- `security-autopilot-reconcile-scheduler-failed-invocations-eu-north-1` (INSUFFICIENT_DATA) [AWS/Events:FailedInvocations]
- `security-autopilot-reconcile-scheduler-target-dlq-depth-eu-north-1` (OK) [AWS/SQS:ApproximateNumberOfMessagesVisible]

## Artifact Files

- JSON: `docs/audit-remediation/evidence/phase2-architecture-20260212T115809Z.json`
- Markdown: `docs/audit-remediation/evidence/phase2-architecture-20260212T115809Z.md`
