# AWS Config enablement - Action: 6d0d78b2-4c24-490f-bc32-5af9a6b5ed7b
# Remediation for: Enable AWS Config (Live Test D1 fail-closed rerun)
...
variable "delivery_bucket_name" {
  type        = string
  default     = "sa-live-d1a-miss-029037611564-0304022103"
