# AWS Config enablement - Action: b2863faf-ba8b-4b41-818c-8af6b5d6f896
# Remediation for: Enable AWS Config (Live Test D2 rerun)
# Account: 029037611564 | Region: ap-south-1
# Control: Config.1
...
variable "delivery_bucket_name" {
  type        = string
  default     = "sa-live-d2r-config-029037611564-0304023013"
