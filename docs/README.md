...
- [Phase 1 + Phase 2 remediation determinism production-only handoff (`BLOCKED / NO-GO`, March 28, 2026)](/Users/marcomaher/AWS%20Security%20Autopilot/docs/test-results/live-runs/20260328T221004Z-remediation-determinism-phase1-phase2-production/README.md)
...
- [S3.2 production-ready grouped rerun (`PASS`, website-policy/BPA blocker and grouped callback precision now both proven on the fresh live path, April 2, 2026 UTC)](/Users/marcomaher/AWS%20Security%20Autopilot/docs/test-results/live-runs/20260402T192426Z-s32-production-ready-rerun/README.md)
- [S3.11 stale-action grouped rerun (`PASS`, stale deleted or drifted bucket members are no longer executable on the fresh live grouped path; scoped recompute wedge fixed separately, April 2-3, 2026 UTC)](/Users/marcomaher/AWS%20Security%20Autopilot/docs/test-results/live-runs/20260402T215309Z-s311-stale-action-rerun/README.md)
- [S3.2 website-policy/BPA grouped rerun (`PARTIAL`, remaining website blocker closed truthfully before execution; fresh rerun exposed separate AWS endpoint instability and pre-redeploy grouped callback flattening, April 2, 2026 UTC)](/Users/marcomaher/AWS%20Security%20Autopilot/docs/test-results/live-runs/20260402T182613Z-s32-website-bpa-downgrade-rerun/README.md)
- [S3.2 CloudFront OAC live rerun successor (`FAIL`, real affected bucket now executable; blocked by local Terraform external-provider startup, April 2, 2026 UTC)](/Users/marcomaher/AWS%20Security%20Autopilot/docs/test-results/live-runs/20260402T010412Z-s32-oac-live-rerun-successor/notes/final-summary.md)
- [Grouped support-bucket helper rerun (`PASS`, April 2, 2026 UTC)](/Users/marcomaher/AWS%20Security%20Autopilot/docs/test-results/live-runs/20260402T034144Z-grouped-support-bucket-helper-rerun/README.md)
- [S3.5 freshness/verification rerun (`PASS`, product-side closure now proven for the already-applied safe fix; stale readiness remains separate, April 2, 2026 UTC)](/Users/marcomaher/AWS%20Security%20Autopilot/docs/test-results/live-runs/20260402T143137Z-s35-freshness-verification-rerun/README.md)
- [S3.5 post-apply freshness debug (`PASS`, reduced the residual issue to stale upstream control-plane events; synthetic control-plane input proves the SaaS readiness path still works, April 2, 2026 UTC)](/Users/marcomaher/AWS%20Security%20Autopilot/docs/test-results/live-runs/20260402T154946Z-s35-post-apply-freshness-debug/notes/final-summary.md)
- [Control-plane forwarder token-drift repair (`PASS`, stale readiness closed on the real live path without reopening `S3.5`, April 2, 2026 UTC)](/Users/marcomaher/AWS%20Security%20Autopilot/docs/test-results/live-runs/20260402T163539Z-control-plane-forwarder-token-drift-repair/notes/final-summary.md)
- [S3.5 safe executable live rerun (`PASS`, safe non-public-policy bundle still executable on production, April 2, 2026 UTC)](/Users/marcomaher/AWS%20Security%20Autopilot/docs/test-results/live-runs/20260402T141121Z-s35-safe-exec-live-rerun/notes/final-summary.md)
- [S3.2 CloudFront OAC adopt/reuse live rerun on April 2, 2026 UTC](/Users/marcomaher/AWS%20Security%20Autopilot/docs/test-results/live-runs/20260402T001833Z-s32-oac-live-rerun/notes/final-summary.md)
- [S3.5 BPA-aware SSL enforcement live rerun on April 1-2, 2026 UTC](/Users/marcomaher/AWS%20Security%20Autopilot/docs/test-results/live-runs/20260401T230346Z-s35-bpa-live-rerun/notes/final-summary.md)
- [WI-5 retained production canary blocker package (March 28, 2026)](/Users/marcomaher/AWS%20Security%20Autopilot/docs/test-results/live-runs/20260328T164043Z-wi5-website-cloudfront-private-canary/README.md)
...
- [Remediation operator UX implementation plan](/Users/marcomaher/AWS%20Security%20Autopilot/docs/features/remediation-operator-ux-implementation-plan.md)
