...
Executable actions:
- 2. Security groups should not allow unrestricted access to ports with high risk (executable_bundle_generated) -> executable/actions/02-arn-aws-ec2-eu-north-1-696505809372-security-gro-ad9328e1

Review-required actions:
- none

Manual-guidance actions:
- 1. Security groups should not allow unrestricted access to ports with high risk (manual_guidance_metadata_only) -> manual_guidance/actions/01-arn-aws-ec2-eu-north-1-696505809372-security-gro-2a1c9d2f
