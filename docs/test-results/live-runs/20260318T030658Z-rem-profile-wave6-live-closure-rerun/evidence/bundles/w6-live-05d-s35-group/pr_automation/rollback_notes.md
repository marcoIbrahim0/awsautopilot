...
- Rollback command: `python3 ./executable/actions/03-arn-aws-s3-security-autopilot-w6-envready-cloudt-332a7d6f/rollback/s3_policy_restore.py`
...
- Rollback command: `python3 ./executable/actions/04-arn-aws-s3-security-autopilot-w6-envready-s315-e-4ca36a85/rollback/s3_policy_restore.py`
...
- Rollback command: `python3 ./executable/actions/06-arn-aws-s3-security-autopilot-w6-envready-s311-e-64650bcf/rollback/s3_policy_restore.py`
...
- Rollback command: `python3 ./executable/actions/07-arn-aws-s3-security-autopilot-w6-envready-config-8e4a902d/rollback/s3_policy_restore.py`
...
- Rollback command: `python3 ./executable/actions/08-arn-aws-s3-security-autopilot-w6-strict-s311-exe-8f1b6cf5/rollback/s3_policy_restore.py`
...
- Rollback command: `python3 ./executable/actions/10-arn-aws-s3-security-autopilot-w6-envready-access-eabfe19e/rollback/s3_policy_restore.py`
...
- Rollback command: `python3 ./executable/actions/11-arn-aws-s3-security-autopilot-w6-envready-s311-r-f3110269/rollback/s3_policy_restore.py`
