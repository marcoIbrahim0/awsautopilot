...
- 1. SSM documents should have the block public sharing setting enabled (review_required_metadata_only) -> review_required/actions/01-aws-account-696505809372-a3447ad4
