# SG restrict public ports (22/3389) - Action: f1e6ea20-740e-4ffc-9f1b-24b2e37502db
# Remediation for: Security groups should not allow unrestricted access to ports with high risk
# Account: 029037611564 | Region: eu-north-1 | Security group: sg-0e5bea6687c7063c1
# Control: EC2.53
