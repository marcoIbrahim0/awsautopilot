# S3.2 migration variant (CloudFront + OAC + private S3) - Action: 26403d52-eff4-47ce-ab52-49bd237e72f5
...
locals {
  bucket_name = "arch1-bucket-evidence-b1-029037611564-eu-north-1"
  # Include action/run-level entropy to avoid account-wide OAC name collisions on reruns.
  oac_name_seed = "${local.bucket_name}-26403d52eff447ceab5249bd237e72f5-20260301210259852062"
