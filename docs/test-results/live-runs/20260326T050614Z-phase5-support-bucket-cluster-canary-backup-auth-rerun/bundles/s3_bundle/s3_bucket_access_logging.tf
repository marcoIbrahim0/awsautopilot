# S3 bucket access logging - Action: 5f5d8617-4da8-4830-a1dc-6b4e98f6b0b0
...
variable "log_bucket_name" {
  ...
  default     = "security-autopilot-phase5-access-logs-696505809372-050614"
}
