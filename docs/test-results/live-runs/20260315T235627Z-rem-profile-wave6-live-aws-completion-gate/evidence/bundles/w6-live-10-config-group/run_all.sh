...
FINISHED_SUCCESS_TEMPLATE={"token": "<REDACTED_TOKEN>", "event": "finished", "reporting_source": "bundle_callback", "action_results": [{"action_id": "0e4108d7-3985-416d-b6cd-7659e8e45113", "execution_status": "success"}]}
FINISHED_FAILED_TEMPLATE={"token": "<REDACTED_TOKEN>", "event": "finished", "reporting_source": "bundle_callback", "action_results": [{"action_id": "0e4108d7-3985-416d-b6cd-7659e8e45113", "execution_status": "failed", "execution_error_code": "bundle_runner_failed", "execution_error_message": "run_actions.sh exited non-zero"}]}
