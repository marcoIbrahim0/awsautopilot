...
-------------------------------
- terraform_plan_timestamp_utc: 2026-03-28T02:33:43+00:00
...
- [warn] s3_policy_merge_risk: Runtime policy capture failed (AccessDenied); customer-run Terraform will fetch and merge the live bucket policy at plan/apply time.
- [warn] access_path_evidence_unavailable: Unable to inspect current bucket policy (AccessDenied).
