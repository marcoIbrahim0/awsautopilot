# S3.2 migration variant (CloudFront + OAC + private S3) - Action: cdb53f5c-8701-497d-a866-4256cddd9d66
...
locals {
  ...
  oac_name_seed = "${local.bucket_name}-cdb53f5c8701497da8664256cddd9d66-20260401004419818175"
