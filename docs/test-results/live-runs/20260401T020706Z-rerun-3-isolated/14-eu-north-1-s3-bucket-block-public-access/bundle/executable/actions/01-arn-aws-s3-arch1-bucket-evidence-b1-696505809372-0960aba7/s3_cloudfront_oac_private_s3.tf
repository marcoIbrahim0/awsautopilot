# S3.2 migration variant (CloudFront + OAC + private S3) - Action: 0960aba7-eddd-48d7-aafc-5379d1e482d9
...
locals {
  ...
  oac_name_seed = "${local.bucket_name}-0960aba7eddd48d7aafc5379d1e482d9-20260401004419814370"
