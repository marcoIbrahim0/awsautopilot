...
locals {
  ...
  oac_name_seed             = "${local.bucket_name}-352ac9b2d34340acb4274c4f285615ef-20260329232413934052"
...
variable "aliases" {
  ...
  default     = ["wi5-gate3-696505809372.ocypheris.com"]
}

variable "route53_hosted_zone_id" {
  type        = string
  description = "Route53 hosted zone ID that owns the aliases."
  default     = "Z081885955B6GUR4IL7E"
}

variable "acm_certificate_arn" {
  type        = string
  description = "CloudFront viewer certificate ARN (must be in us-east-1)."
  default     = "arn:aws:acm:us-east-1:696505809372:certificate/509785ff-eef1-4071-bddc-d275f1dfa6ed"
}
