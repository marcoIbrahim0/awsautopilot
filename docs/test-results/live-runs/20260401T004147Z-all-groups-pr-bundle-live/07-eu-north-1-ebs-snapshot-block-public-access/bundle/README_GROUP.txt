...
Executable actions:
- 1. Amazon EBS Snapshots should not be publicly accessible (executable_bundle_generated) -> executable/actions/01-aws-account-696505809372-087eaa5d
- 2. Amazon EBS Snapshots should not be publicly accessible (executable_bundle_generated) -> executable/actions/02-arn-aws-ec2-eu-north-1-696505809372-snapshotbloc-4c3876e4
