# S3.2 migration variant (CloudFront + OAC + private S3) - Action: bdfa85bc-b3a3-4456-b8d9-9ed1dd895ad3
...
locals {
  ...
  oac_name_seed = "${local.bucket_name}-bdfa85bcb3a34456b8d99ed1dd895ad3-20260401004419818930"
