# S3.2 migration variant (CloudFront + OAC + private S3) - Action: dedc7b1c-0300-4a28-8806-6735354facba
...
locals {
  ...
  oac_name_seed                       = "${local.bucket_name}-dedc7b1c03004a2888066735354facba-20260402002357688435"
