# S3.2 migration variant (CloudFront + OAC + private S3) - Action: fb27abe2-d234-4627-9ee2-6227b8447efd
...
locals {
  ...
  oac_name_seed                       = "${local.bucket_name}-fb27abe2d23446279ee26227b8447efd-20260402003514698501"
