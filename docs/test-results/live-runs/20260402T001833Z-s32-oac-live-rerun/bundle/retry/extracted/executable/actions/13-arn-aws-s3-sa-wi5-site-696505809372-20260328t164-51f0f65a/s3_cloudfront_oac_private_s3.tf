# S3.2 migration variant (CloudFront + OAC + private S3) - Action: 51f0f65a-8f13-44b1-b889-1243080bd069
...
locals {
  bucket_name                         = "sa-wi5-site-696505809372-20260328t164043z"
  ...
  oac_name_seed                       = "${local.bucket_name}-51f0f65a8f1344b1b8891243080bd069-20260402003514689722"
