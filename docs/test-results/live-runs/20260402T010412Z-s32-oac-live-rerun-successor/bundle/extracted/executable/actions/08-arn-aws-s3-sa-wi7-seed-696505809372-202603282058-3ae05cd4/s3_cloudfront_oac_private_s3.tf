# S3.2 migration variant (CloudFront + OAC + private S3) - Action: 3ae05cd4-4f24-4371-ad5d-63e2ae01d341
...
locals {
  bucket_name                         = "sa-wi7-seed-696505809372-20260328205857"
  ...
  oac_name_seed                       = "${local.bucket_name}-3ae05cd44f244371ad5d63e2ae01d341-20260402010529575977"
