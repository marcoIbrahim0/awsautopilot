# S3.2 migration variant (CloudFront + OAC + private S3) - Action: fddd2631-0898-48d7-8bf8-5e638c4ac493
...
locals {
  bucket_name                         = "arch1-bucket-evidence-b1-696505809372-eu-north-1"
  ...
  oac_name_seed                       = "${local.bucket_name}-fddd2631089848d78bf85e638c4ac493-20260402010529623586"
