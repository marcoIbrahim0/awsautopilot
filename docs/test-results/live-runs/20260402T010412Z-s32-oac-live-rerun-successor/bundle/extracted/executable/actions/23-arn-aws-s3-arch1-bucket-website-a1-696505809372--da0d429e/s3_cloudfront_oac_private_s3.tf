# S3.2 migration variant (CloudFront + OAC + private S3) - Action: da0d429e-6f16-461e-be2f-09ea7997e30a
...
locals {
  ...
  oac_name_seed                       = "${local.bucket_name}-da0d429e6f16461ebe2f09ea7997e30a-20260402010529606437"
