# S3.2 migration variant (CloudFront + OAC + private S3) - Action: abf5eb48-ea9b-48d0-a534-236cf8818bf9
...
locals {
  ...
  oac_name_seed                       = "${local.bucket_name}-abf5eb48ea9b48d0a534236cf8818bf9-20260402010529624885"
