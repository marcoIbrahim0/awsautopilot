# S3.2 migration variant (CloudFront + OAC + private S3) - Action: f497bc0c-ddcb-4191-8fa5-c6ed21bbe134
...
locals {
  ...
  oac_name_seed                       = "${local.bucket_name}-f497bc0cddcb41918fa5c6ed21bbe134-20260402010529626092"
