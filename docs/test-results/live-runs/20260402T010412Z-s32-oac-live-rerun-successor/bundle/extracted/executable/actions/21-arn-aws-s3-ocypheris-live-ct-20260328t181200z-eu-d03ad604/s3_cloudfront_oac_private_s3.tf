# S3.2 migration variant (CloudFront + OAC + private S3) - Action: d03ad604-a057-4677-8c12-0934a27317ea
...
locals {
  bucket_name                         = "ocypheris-live-ct-20260328t181200z-eu-north-1"
  ...
  oac_name_seed                       = "${local.bucket_name}-d03ad604a05746778c120934a27317ea-20260402010529604250"
