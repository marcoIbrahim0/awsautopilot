# S3.2 migration variant (CloudFront + OAC + private S3) - Action: 496f8cc3-f3c0-4587-becf-6ec0d5b68d61
...
locals {
  bucket_name                         = "security-autopilot-access-logs-696505809372-r94854"
  ...
  oac_name_seed                       = "${local.bucket_name}-496f8cc3f3c04587becf6ec0d5b68d61-20260402010529578195"
