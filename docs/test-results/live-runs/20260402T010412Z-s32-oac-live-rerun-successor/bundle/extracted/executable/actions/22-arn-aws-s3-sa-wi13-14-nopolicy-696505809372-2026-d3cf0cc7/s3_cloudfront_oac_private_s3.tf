# S3.2 migration variant (CloudFront + OAC + private S3) - Action: d3cf0cc7-e545-4151-818c-18f8d806c919
...
locals {
  ...
  oac_name_seed                       = "${local.bucket_name}-d3cf0cc7e5454151818c18f8d806c919-20260402010529605330"
