...
Last updated: 2026-02-28T22:20:00Z (Wave 4 tests 09-12 post-deploy rerun)
...
| 9 | Test 20 | Internal digest | Correct user token gets 200 on internal endpoint | Missing auth guard on `/api/internal/*` | 🔴 BLOCKING | ✅ FIXED (Wave 4 Test 10 rerun, 2026-02-28: unauthorized bearer and wrong-secret calls returned `403`) |
