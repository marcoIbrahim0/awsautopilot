...
Last updated: 2026-03-01T04:03:52Z (Wave 7 Test 23 full closure rerun)
...
| Wave 7 | 23–28 | 2026-03-01 | 0 | 0 | 1 | 0 |
| Wave 8 | 29–33 | — | — | — | — | — |
| Wave 9 | 34–35 | — | — | — | — | — |
| **TOTAL** | **35** | **2026-03-01** | **21** | **1** | **1** | **0** |
...
| 7 | `/api/actions/reconcile` + refresh chain | Post-apply refresh calls (`ingest/compute/reconcile`) accept and return `202` | Target S3.2 finding/action closure did not transition from `NEW/open` within 15-minute near-real-time window after successful IaC apply | Test 23 | — |
