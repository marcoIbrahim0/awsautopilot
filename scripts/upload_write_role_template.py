...
Defaults: version=v1.4.0, bucket=security-autopilot-templates, region=eu-north-1.
...
def main() -> None:
    ...
    parser.add_argument("--version", default="v1.4.0", help="Version segment for key (e.g. v1.4.0)")
